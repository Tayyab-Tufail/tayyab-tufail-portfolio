...
# Launch Edge with remote debugging port 9250 and allow origins
edge_path = r'C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe'
user_data = r'c:\Users\Laptop\Desktop\Porfolio\tayyab-tufail-portfolio\.capture-cdp-9250'
...
print('Launching Edge CDP process with remote-allow-origins=*...')
proc = subprocess.Popen(cmd)
time.sleep(3)

import websocket

# Get WebSocket URL from http://127.0.0.1:9250/json
resp = urllib.request.urlopen('http://127.0.0.1:9250/json')
...
ws.close()
proc.terminate()
print('All 12 NexaMart screenshots successfully captured via CDP!')
