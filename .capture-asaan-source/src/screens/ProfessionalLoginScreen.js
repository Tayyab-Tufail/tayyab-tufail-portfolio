...
const ProfessionalLoginScreen = () => {
  ...
  const { updateUserType, updateUserData, userData } = useContext(AppContext);
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await api.post("/auth/professional/login", {
      ...
      // Update user type and user data in global state
